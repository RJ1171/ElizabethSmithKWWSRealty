...
export function getFeaturedListings(allListings) {
  return allListings
    ...
    .filter((listing) => listing.agentName === FEATURED_AGENT_NAME || listing.coListingAgent === FEATURED_AGENT_NAME)
    .sort((a, b) => b.price - a.price || a.address.localeCompare(b.address))
